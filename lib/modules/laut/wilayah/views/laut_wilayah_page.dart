...
import 'package:strategi_hub_app/modules/laut/wilayah/views/detail_prov_page.dart';
...
class LautWilayahPage extends GetView<LautController> {
  const LautWilayahPage({super.key, required this.menuArgument});
                            ...
                            return InkWell(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    "${startIndex + index + 1}.",
                                    style: Get.textTheme.labelLarge!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 14)),
                                  ),
