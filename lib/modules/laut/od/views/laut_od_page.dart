...
class LautOdPage extends GetView<LautController> {
  const LautOdPage({super.key});
          ...
          Column(
            children: [
              HeaderFilter(
                ...
                onSelectedDate: controller.updateOdFilterDate,
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: Icon(
                                IconlyLight.search,
                                size: isUnfolded ? Sizes.s18 : (isSmallScreen ? Sizes.s8 : Sizes.s18),
                                color: AppColors.lightGreyColor,
                              ),
                        ...
                        Obx(
                          () {
                            ...
                            if (controller.isOdChart.value) {
                              return chartData.isNotEmpty == true
...
class OdTable extends StatelessWidget {
  final List<OdChartData> chartData;
  const OdTable({
    super.key,
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(
                width: Get.width * 0.15,
                child: SvgPicture.asset(AssetConstant.shipIcon),
              ),
            ],
          ),
        ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          children: [
                            Text(chartData[index].departure?.toString() ?? '',
                                textAlign: TextAlign.center,
                                style: Get.textTheme.labelMedium!
                                    .copyWith(fontWeight: FontWeight.w400)),
                            Text(chartData[index].arrival?.toString() ?? '',
                                textAlign: TextAlign.center,
                                style: Get.textTheme.labelMedium!
                                    .copyWith(fontWeight: FontWeight.w400)),
                          ],
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          children: [
                            Text(chartData[index].vehicleDeparture.toString(),
                                textAlign: TextAlign.center,
                                style: Get.textTheme.labelMedium!
                                    .copyWith(fontWeight: FontWeight.w400)),
                            Text(chartData[index].vehicleArrival.toString(),
                                textAlign: TextAlign.center,
                                style: Get.textTheme.labelMedium!
                                    .copyWith(fontWeight: FontWeight.w400)),
                          ],
...
class OdChart extends GetView<LautController> {
  final List<OdChartData> chartData;
  ...
  double _calculateDynamicInterval(double maxValue) {
    ...
    final List<double> intervals = Constant.chartIntervals;

    // Select the smallest interval that results in fewer than 10 steps
    for (double interval in intervals) {
      if ((maxValue / interval).ceil() <= 10) {
        return interval;
      }
    }

    // Fallback if the maxValue is very large
    return 100000;
  }
      ...
      child: SizedBox(
        ...
        child: SfCartesianChart(
          ...
          primaryYAxis: NumericAxis(
            ...
            interval: _calculateDynamicInterval(highestValue),
            labelStyle: Get.textTheme.bodySmall!.copyWith(
              fontSize: isUnfolded ? 10 : (isSmallScreen ? 10 : 8),
            ),
            labelIntersectAction: AxisLabelIntersectAction.wrap,
          ...
          series: <BarSeries<OdChartData, String>>[
            BarSeries<OdChartData, String>(
              dataSource: chartData,
              onPointTap: (data) {
                Get.toNamed(
                  DetailLautOdPage.routeName,
                  arguments: OdDetailArgument(
              ...
              xValueMapper: (OdChartData sales, _) => sales.combinedLabel,
              yValueMapper: (OdChartData sales, _) => sales.total,
