...
class DetailLautOdPage extends GetView<LautOdController> {
  static String routeName = '/detail-laut-od-page';
  const DetailLautOdPage({super.key});
                      ...
                      children: [
                        Text(
                          ...
                          style: Get.textTheme.bodyMedium!
                              .copyWith(fontWeight: FontWeight.w600, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : FontSizes.s10)),
                        ),
                        SizedBox(height: Sizes.s4),
                        Text(
                          controller.originCityName.value.isEmpty ? '-' : controller.originCityName.value,
                        ...
                        SizedBox(height: Sizes.s4),
                        Text(
                          controller.destinationCityName.value.isEmpty ? '-' : controller.destinationCityName.value,
                          style: Get.textTheme.labelMedium!.copyWith(
                              fontWeight: FontWeight.w400, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : FontSizes.s10)),
                        ),
                        SizedBox(height: Sizes.s10),
