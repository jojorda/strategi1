...
class LautSimpul extends GetView<LautController> {
  static const routeName = '/Laut-simpul';
      ...
      return Column(
        children: [
          ...
          _buildTerminalSection(
              "Pelabuhan Umum",
            [
              _NodeData("Pelabuhan Merak", "31.816", "172", "55.216", "124"),
              _NodeData("Pelabuhan Bakauheni", "31.816", "172", "55.216", "124"),
              _NodeData("Pelabuhan Gilimanuk", "31.816", "172", "55.216", "124"),
              _NodeData("Pelabuhan Belawan", "31.816", "172", "55.216", "124"),
            ],
            ),
            const SizedBox(height: 8),
            _buildTerminalSection(
