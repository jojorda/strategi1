...
class LautOperatorPage extends GetView<LautOperatorController> {
  const LautOperatorPage({super.key});
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: TextFormField(
                          initialValue: controller.currentSearchOperator.value,
                          onChanged: (value) =>
                              controller.currentSearchOperator.value = value,
                ...
                children: [
                  ExpandablePanel(
                    ...
                    expanded: GestureDetector(
                      onTap: () {
                        Get.toNamed(DetailLautOperatorPage.routeName);
                      },
                      child: Container(
                        width: Get.width,
