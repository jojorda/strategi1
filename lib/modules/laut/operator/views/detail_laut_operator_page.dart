...
import 'package:strategi_hub_app/modules/laut/operator/views/laut_sarana_page.dart';
import 'package:strategi_hub_app/modules/laut/operator/views/origin_destination_page.dart';

class DetailLautOperatorPage extends StatelessWidget {
  static String routeName = '/detail-laut-operator-page';
  const DetailLautOperatorPage({super.key});
                        ...
                        children: [
                          Text(
                            ...
                            style: Get.textTheme.labelLarge!
                                .copyWith(fontWeight: FontWeight.bold, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s12)),
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '+82 434324322',
                                style: Get.textTheme.titleSmall!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s12)),
                              ),
                            ],
                          ),
                          Row(
              ...
              Row(
                children: [
                  Expanded(
                    child: Text(
                      'Rata - Rata OTP',
                      style: Get.textTheme.labelLarge!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s12)),
                    ),
                  ),
                  Container(
                    decoration: BoxDecoration(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: Get.textTheme.titleMedium!
                            .copyWith(color: AppColors.whiteColor, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s12)),
                      ),
                    ),
                  )
                ],
                  ...
                  SizedBox(width: Sizes.s10),
                    Expanded(
                        child: CustomPrimaryButtons(
                            ...
                            onPress: () {
                              Get.to(() => const OriginDestinationPage());
                            },
                            text: '8 OD')),
                ],
              )
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        style: Get.textTheme.labelMedium!
                            .copyWith(fontWeight: FontWeight.w400, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s12)),
                      ),
                    ),
                    Expanded(
                    ...
                    SizedBox(
                      ...
                      child: Image.asset(
                        AssetConstant.pdf,
                        height: isUnfolded ? Sizes.s20 : (isSmallScreen ? Sizes.s14 : Sizes.s20),
                      ),
                    ),
                  ],
                ),
