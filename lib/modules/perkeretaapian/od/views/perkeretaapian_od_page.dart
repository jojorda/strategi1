...
class PerkeretaapianOdPage extends GetView<PerkeretaapianController> {
  const PerkeretaapianOdPage({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            style: Get.textTheme.labelLarge!.copyWith(
                              fontSize:
                                  isUnfolded ? 14 : (isSmallScreen ? 11 : 14),
                            ),
                            initialValue: controller.currentSearchOd.value,
                            decoration: InputDecoration(
                              ...
                              suffixIcon: Icon(
                                IconlyLight.search,
                                size: isUnfolded ? Sizes.s18 : (isSmallScreen ? Sizes.s12 : Sizes.s18),
                                color: AppColors.lightGreyColor,
                              ),
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            children: [
                              Text(
                                  chartData[index].arrival?.toDotSeparated() ??
                                      '',
                                  textAlign: TextAlign.center,
                                  style: Get.textTheme.labelMedium!.copyWith(
                                      fontWeight: FontWeight.w400,
...
class OdChart extends GetView<PerkeretaapianController> {
  final List<OdChartData> chartData;
        ...
        child: SfCartesianChart(
          ...
          series: <BarSeries<OdChartData, String>>[
            BarSeries<OdChartData, String>(
              ...
              onPointTap: (data) {
                final od = chartData[data.pointIndex ?? 0];
                final args = OdDetailArgument(
                  ...
                  idOrigin: od.idOrigin,
                  idDestination: od.idDestination,
                  origin: od.origin,
                  destination: od.destination,
                  selectedFilter: controller.selectedFilter.value,
                  originCityName: od.originCity,
                  destinationCityName: od.destinationCity,
                  originType: od.originType,
                  destinationType: od.destinationType,
                );

                Get.toNamed(DetailPerkeretaapianOdPage.routeName,
                    arguments: args);
              },
