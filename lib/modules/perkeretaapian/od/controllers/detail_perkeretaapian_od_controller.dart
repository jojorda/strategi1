...
class PerkeretaapianOdDetailController extends GetxController {
  ...
  Rx<OdGraphData?> sessionalOdDetailData = Rx<OdGraphData?>(null);
  Rx<OdGraphData?> routineOdDetailData = Rx<OdGraphData?>(null);
  Rx<OdGraphData?> currentOdDetailData = Rx<OdGraphData?>(null);
  Rx<TrafficData?> currentTrafficDataOrigin = Rx<TrafficData?>(null);
  Rx<TrafficData?> currentTrafficDataDestination = Rx<TrafficData?>(null);
  ...
  RxString originStation = ''.obs;
  RxString destinationStation = ''.obs;
  ...
  RxString idOrigin = ''.obs;
  RxString idDestination = ''.obs;

  @override
  void onInit() {
    final arguments = Get.arguments;
    if (arguments is OdDetailArgument) {
      isRoutine.value = arguments.isRoutine ?? false;
      originStation.value = arguments.origin ?? '';
      destinationStation.value = arguments.destination ?? '';
      ...
      idOrigin.value = arguments.idOrigin ?? '';
      idDestination.value = arguments.idDestination ?? '';
