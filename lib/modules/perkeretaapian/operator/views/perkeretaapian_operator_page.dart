...
class PerkeretaapianOperatorPage
    extends GetView<PerkeretaapianOperatorController> {
  const PerkeretaapianOperatorPage({super.key});
          ...
          child: Row(
            children: [
              Expanded(
                child: TextFormField(
                  onChanged: (value) =>
                      controller.currentSearchOperator.value = value.trim(),
        ...
        Expanded(
          child: Obx(
            () {
              ...
              // }
              List<Operator> datas = controller.currentListOperatorData.value;
                ...
                children: [
                  ExpandablePanel(
                    ...
                    expanded: GestureDetector(
                      onTap: () {
                        Get.toNamed(
                          DetailPerkeretaapianOperatorPage.routeName,
                          arguments: data,
                        );
                      },
                      child: Container(
