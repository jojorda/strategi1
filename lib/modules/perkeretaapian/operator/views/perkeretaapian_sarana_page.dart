...
class PerkeretaapianSaranaPage extends StatelessWidget {
  static String routeName = '/perkeretaapian-sarana-page';
  const PerkeretaapianSaranaPage({super.key});
                            ...
                            Expanded(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text('BUS ROSALIA INDAH 001',
                                          style: Get.textTheme.labelLarge!
                                              .copyWith(
