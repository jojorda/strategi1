...
class DetailPerkeretaapianOperatorPage extends StatelessWidget {
  static String routeName = '/detail-perkeretaapian-operator-page';
  const DetailPerkeretaapianOperatorPage({super.key});
