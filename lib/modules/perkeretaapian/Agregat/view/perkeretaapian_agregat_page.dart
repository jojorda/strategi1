...
class PerkeretaapianAgregat extends GetView<PerkeretaapianController> {
  static const routeName = '/aggregate';
  const PerkeretaapianAgregat({super.key});
    ...
    return [
      ...
      DataColumn(
        ...
        label: SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isUnfolded ? 33.0 : (isSmallScreen ? 10.0 : 15.0)),
            child: SvgPicture.asset(
              AssetConstant.trainIcon,
              height: 17,
            ),
