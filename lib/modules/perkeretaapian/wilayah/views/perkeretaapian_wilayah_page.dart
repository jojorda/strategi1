...
import 'package:strategi_hub_app/modules/perkeretaapian/wilayah/views/detail_prov_page.dart';
import 'package:strategi_hub_app/modules/perkeretaapian/controllers/perkeretaapian_controller.dart';

class PerkeretaapianWilayahPage extends GetView<PerkeretaapianController> {
  const PerkeretaapianWilayahPage({super.key});
                            ...
                            return InkWell(
                              onTap: () => Get.toNamed(
                                ...
                                arguments: {
                                  'provinceData': item,
                                  'provinceId': item.id,
                                  'title': 'Perkeretaapian',
                                  'moda': ModaType.stasiun
                                },
                              ),
                              child: Row(
                                children: [
