...
class DetailKotaPage extends GetView<DetailKotaController> {
  static const routeName = '/detail-kota';
  const DetailKotaPage({super.key});
          ...
          () => Column(
            ...
            children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${controller.title.value == 'Jalan' ? 'TT${controller.data.value?.type}  | ' : ''}${controller.data.value?.city ?? '-'}",
              ...
              SizedBox(
                  height: isUnfolded
                      ? Sizes.s8
                      : (isSmallScreen ? Sizes.s8 : Sizes.s12)),
                      ...
                      GoogleMapsView(markers: [
                        MarkerItem(
                          latitude: double.tryParse(
                              controller.data.value?.latitude ?? ''),
                          longitude: double.tryParse(
                              controller.data.value?.longitude ?? ''),
                          markerId: '',
                          title: '',
                        )
                      ]),
      ...
      return SizedBox(
        ...
        child: Obx(() {
          return SfCartesianChart(
            ...
            series:
                _buildChartSeries(trafficData, controller.hideDeparture.value),
          );
        }),
      );
    });
  ...
  List<CartesianSeries<ChartData, String>> _buildChartSeries(
      dynamic trafficData, bool hideDeparture) {
  ...
  Widget _buildLegendItem({
    ...
    return Row(
      children: [
        SvgPicture.asset(
          isVehicle ? getIcon(modaType) : AssetConstant.userGroup,
          width: 14,
          height: 14,
          color: color,
        ),
    ...
    return Obx(() {
      ...
      return Row(
        ...
        children: [
          ...
          if (!controller.hideDeparture.value) ...[
