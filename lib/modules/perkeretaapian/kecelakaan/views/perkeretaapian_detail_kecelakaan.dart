...
class PerkeretaapianAccidentReportPage extends StatefulWidget {
  final double latitude = -7.2016;
  final double longitude = 112.7378;

  const PerkeretaapianAccidentReportPage({Key? key}) : super(key: key);

  @override
  State<PerkeretaapianAccidentReportPage> createState() => _PerkeretaapianAccidentReportPageState();
}

// Kemudian buat State class
class _PerkeretaapianAccidentReportPageState extends State<PerkeretaapianAccidentReportPage> {
