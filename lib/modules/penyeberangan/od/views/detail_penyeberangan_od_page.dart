...
class DetailPenyeberanganOdPage
    extends GetView<PenyeberanganOdDetailController> {
  static String routeName = '/detail-penyeberangan-od-page';
  const DetailPenyeberanganOdPage({super.key});
