...
class PenyeberanganSimpul extends GetView<PenyeberanganController> {
  static const routeName = '/penyeberangan-simpul';
        ...
        ? Column(
          children: [
            ...
            _buildTerminalSection(
              "Penyeberangan | Semua Provinsi",
              [
                _NodeData("Merak", "31.816", "172", "56.216", "124"),
                _NodeData("Bakauheni", "31.816", "172", "56.216", "124"),
                _NodeData("Selayar", "31.816", "172", "56.216", "124"),
                _NodeData("Bau-Bau", "31.816", "172", "56.216", "124"),
                _NodeData("Bojoe", "31.816", "172", "56.216", "124"),
                _NodeData("Luwuk", "31.816", "172", "56.216", "124"),
                _NodeData("Bitung", "31.816", "172", "56.216", "124"),
                _NodeData("Kolaka", "31.816", "172", "56.216", "124"),
                _NodeData("Woara", "31.816", "172", "56.216", "124"),
              ],
              context,
            ),
            const SizedBox(height: 8),
            Obx(() => Pagination(
              ...
              nextIcon: Icon(
                Icons.chevron_right,
                size: isUnfolded ? Sizes.s22 : (isSmallScreen ? Sizes.s12 : Sizes.s16),
              ...
              activeBtnStyle: ButtonStyle(
                fixedSize: MaterialStateProperty.all(
                  Size(isUnfolded ? Sizes.s12 : (isSmallScreen ? Sizes.s12 : Sizes.s16), isUnfolded ? Sizes.s12 : (isSmallScreen ? Sizes.s12 : Sizes.s16)),
                ),
                padding: MaterialStateProperty.all(EdgeInsets.zero),
                minimumSize: MaterialStatePropertyAll(Size(isUnfolded ? Sizes.s12 : (isSmallScreen ? Sizes.s12 : Sizes.s16), isUnfolded ? Sizes.s12 : (isSmallScreen ? Sizes.s12 : Sizes.s16))),
              ...
              activeTextStyle: Get.textTheme.bodySmall!
                              .copyWith(
                                ...
                                fontSize: isUnfolded ? 12 : (isSmallScreen ? 9 : 11),
                              ),
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  "Penyeberangan | Kab. Lampung Selatan",
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.bold,
                    color: Colors.black,
                ...
                child: Row(
                  children: [
                    SizedBox(
                      width: 24,
                      child: Padding(
                        padding: EdgeInsets.only(left: isUnfolded ? 13.0 : isSmallScreen ? 10.0 : 13.0),
                        child: Text(
                          "${index + 1}",
                    ...
                    Expanded(
                      child: Padding(
                        padding: EdgeInsets.only(left: isUnfolded ? 29.0 : isSmallScreen ? 15.0 : 29.0),
                        child: Text(
                          node.name,
                          style: TextStyle(fontSize: 12),
                        ),
