...
class PenyeberanganAgregat extends GetView<PenyeberanganController> {
  static const routeName = '/aggregate';
  const PenyeberanganAgregat({super.key});
      ...
      children: [
        isVehicle
            ? SvgPicture.asset(
                ...
                width: isUnfolded ? 14 : (isSmallScreen ? 14 : 14),
                height: isUnfolded ? 14 : (isSmallScreen ? 14 : 14),
                color: color,
              )
            : SvgPicture.asset(
        ...
        Text(
          value,
          style: Get.textTheme.labelMedium!.copyWith(color: color, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 14)),
        ),
        const SizedBox(width: 2),
        Text(label, style: Get.textTheme.labelMedium!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 14)) ),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() => Text(
              ...
              style: Get.textTheme.labelMedium!.copyWith(fontSize: isUnfolded ? 12 : (isSmallScreen ? 10 : 12)),
            )),
      ],
    );
  }
  ...
  Widget _buildCapacityChart() {
    return Obx(() {
      final chartData = controller.currentAggregateData.value?.chartCapacity;
      ...
      return SizedBox(
        height: 250,
        child: _buildCapacityCartesianChart(chartData, maxValue.toDouble()),
      );
    });
  }
  ...
  Widget _buildAggregateChart() {
    return Obx(() {
      ...
      return SizedBox(
        height: 300,
        child: _buildAggregateCartesianChart(chartData, maxValue),
      );
    });
  }
    ...
    return [
      ...
      DataColumn(
        ...
        label: SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isUnfolded ? 50.0 : (isSmallScreen ? 10.0 : 15.0)),
            child: SvgPicture.asset(
              AssetConstant.users,
              height: 15,
            ),
      ...
      DataColumn(
        ...
        label: SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isUnfolded ? 28.0 : (isSmallScreen ? 10.0 : 15.0)),
            child: SvgPicture.asset(
              AssetConstant.boatIcon,
              height: 17,
            ),
  ...
  Widget _buildCapacityCartesianChart(
    ...
    return SfCartesianChart(
      ...
      series: <CartesianSeries<MapEntry<String, int>, String>>[
        StackedBarSeries<MapEntry<String, int>, String>(
          dataSource: _sortChartCapacityData(chartData),
          xValueMapper: (data, _) => _mapVehicleTypeToLabel(data),
  ...
  String _mapVehicleTypeToLabel(MapEntry<String, dynamic> data) {
    switch (data.key) {
      case 'motor':
        return 'Motor';
      case 'roda4':
  ...
  List<MapEntry<String, int>> _sortChartCapacityData(
