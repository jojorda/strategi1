...
class DetailPenyeberanganOperatorPage extends StatelessWidget {
  static String routeName = '/detail-penyeberangan-operator-page';
  const DetailPenyeberanganOperatorPage({super.key});
