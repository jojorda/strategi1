...
import 'package:strategi_hub_app/modules/penyeberangan/wilayah/views/detail_prov_page.dart';
import 'package:strategi_hub_app/modules/penyeberangan/controllers/penyeberangan_controller.dart';

class PenyeberanganWilayahPage extends GetView<PenyeberanganController> {
  const PenyeberanganWilayahPage({super.key});
                  ...
                  child: Column(
                    children: [
                      CustomSearchField(
                        ...
                        label: "Username",
                        labelFontSize:
                            isUnfolded ? 14 : (isSmallScreen ? 12 : 13),
                        hintFontSize:
                            isUnfolded ? 14 : (isSmallScreen ? 14 : 12),
                        maxLines: 1,
                        validator: (value) {},
                      ),
