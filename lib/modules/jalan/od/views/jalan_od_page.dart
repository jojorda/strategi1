...
class JalanOdPage extends GetView<JalanController> {
  const JalanOdPage({super.key});
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                height: isUnfolded
                                    ? Sizes.s20
                                    : (isSmallScreen ? Sizes.s14 : Sizes.s20),
                                width: isUnfolded
                                    ? Sizes.s30
                                    : (isSmallScreen ? Sizes.s14 : Sizes.s30),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: Icon(
                                ...
                                size: isUnfolded
                                    ? Sizes.s12
                                    : (isSmallScreen ? Sizes.s13 : Sizes.s18),
                                color: AppColors.lightGreyColor,
                              ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: SvgPicture.asset(
                  ...
                  height: isUnfolded
                      ? Sizes.s10
                      : (isSmallScreen ? Sizes.s11 : Sizes.s13),
                ),
              ),
              SizedBox(width: Sizes.s4),
              SizedBox(
      ...
      child: Row(
        children: [
          Container(
            height: isUnfolded
                ? Sizes.s18
                : (isSmallScreen ? Sizes.s12 : Sizes.s18),
            width: isUnfolded
                ? Sizes.s18
                : (isSmallScreen ? Sizes.s12 : Sizes.s18),
            alignment: Alignment.center,
            ...
            child: value == true
                ? Center(
                    child: Icon(
                      ...
                      size: isUnfolded
                          ? Sizes.s12
                          : (isSmallScreen ? Sizes.s12 : Sizes.s16),
          ...
          Text(
            ...
            style: Get.textTheme.labelMedium!.copyWith(
                fontWeight: FontWeight.w400,
                color: AppColors.primaryColor,
                fontSize: isUnfolded ? 14 : (isSmallScreen ? 10 : Sizes.s12)),
          ),
        ],
      ),
    );
...
class OdChart extends GetView<JalanController> {
  final List<OdChartData> chartData;
