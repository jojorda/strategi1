...
class JalanAgregat extends GetView<JalanController> {
  static const routeName = '/aggregate';
  const JalanAgregat({super.key});
  ...
  Widget _buildLegendItem({
    ...
    final isUnfolded = MediaQuery.of(context).size.width > 600;
    final isSmallScreen = MediaQuery.of(context).size.height < 700 || MediaQuery.of(context).size.width < 380;
    return Row(
      children: [
        isVehicle
            ? SvgPicture.asset(
        ...
        Text(
          value,
          style:
              Get.textTheme.labelMedium!.copyWith(color: color, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 14)),
        ),
  ...
  double _calculateChartMaxValue(TrafficData trafficData) {
    if (controller.showVehicleData.value) {
      ...
      return max(departures, arrivals).toDouble();
    } else {
      final departures =
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Obx(() => Text(
                  ...
                  style: Get.textTheme.labelMedium!
                      .copyWith(fontSize: isUnfolded ? 10 : (isSmallScreen ? 10 : 12)),
                )),
            Obx(() => Transform.scale(
                  scale: 0.6,
        ...
        Obx(() => Text(
              ...
              style: TextStyle(fontSize: isUnfolded ? 12 : (isSmallScreen ? 10 : 11)),
            )),
      ],
    );
  }
    ...
    return [
      ...
      DataColumn(
        ...
        label: SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isUnfolded ? 60.0 : (isSmallScreen ? 30.0 : 15.0)),
            child: SvgPicture.asset(
              AssetConstant.users,
              height: 15,
            ),
      ...
      DataColumn(
        ...
        label: SizedBox(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: isUnfolded ? 33.0 : (isSmallScreen ? 16.0 : 10.0)),
            child: SvgPicture.asset(
