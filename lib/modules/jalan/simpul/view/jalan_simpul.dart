...
class JalanSimpul extends GetView<JalanController> {
  static const routeName = '/jalan-simpul';
  ...
  Widget _buildTransportationNodeList(context) {
    return Obx(() {
      ...
      if (showPaginatedView.value) {
        return _buildPaginatedTerminalList(context);
      }
      return Column(
        children: [
          Padding(
          ...
          _buildTerminalSection(
              "Terminal Tipe A",
            [
            _NodeData("Purabaya", "31.816", "172", "55.216", "124"),
            _NodeData("Kartonegoro", "31.816", "172", "55.216", "124"),
            _NodeData("Likupang", "31.816", "172", "55.216", "124"),
            _NodeData("Pulo Gebang", "31.816", "172", "55.216", "124"),
          ],
            ),
            const SizedBox(height: 8),
            _buildTerminalSection(
  ...
  Widget _buildPaginatedTerminalList(context) {
    final screenHeight = MediaQuery.of(context).size.height;
    final screenWidth = MediaQuery.of(context).size.width;
    final isSmallScreen = screenHeight < 700 || screenWidth < 380;
    final isUnfolded = screenWidth > 600;
    return Column(
      ...
      children: [
        ...
        Obx(() => Pagination(
              ...
              nextIcon: Icon(
                Icons.chevron_right,
                size: isUnfolded ? Sizes.s16 : (isSmallScreen ? Sizes.s10 : Sizes.s22),
              ...
              activeBtnStyle: ButtonStyle(
                fixedSize: MaterialStateProperty.all(
                  Size(isUnfolded ? Sizes.s18 : (isSmallScreen ? Sizes.s14 : Sizes.s18), Sizes.s22),
                ),
                padding: MaterialStateProperty.all(EdgeInsets.all(0.1)),
                minimumSize: MaterialStatePropertyAll(Size(isUnfolded ? Sizes.s18 : (isSmallScreen ? Sizes.s14 : Sizes.s18), Sizes.s22)),
              ...
              activeTextStyle: Get.textTheme.bodySmall!.copyWith(color: AppColors.whiteColor, fontSize: isUnfolded ? 12 : (isSmallScreen ? 12 : 12)),
              inactiveTextStyle: Get.textTheme.bodySmall!.copyWith(color: Color(0xFF919191), fontSize: isUnfolded ? 12 : (isSmallScreen ? 12 : 12)),
            )),
      ],
    );
  }
