...
class JalanWilayahPage extends GetView<JalanController> {
  const JalanWilayahPage({super.key});
              ...
              return SingleChildScrollView(
                child: ConstrainedBox(
                  constraints: BoxConstraints(
                    minHeight: isUnfolded ? constraints.maxHeight + 10 : (isSmallScreen ? constraints.maxHeight + 30 : constraints.maxHeight + 50),
                  ),
                  child: Column(
                    children: [
                      CustomSearchField(
                            ...
                            return InkWell(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    "${startIndex + index + 1}.",
                                    style: Get.textTheme.labelLarge?.copyWith(fontSize: isUnfolded? 14: (isSmallScreen? 12: 12)),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    child: Icon(
                                      Icons.chevron_right,
                                      size: isUnfolded? Sizes.s17: (isSmallScreen? Sizes.s17: Sizes.s24),
                                    ),
                                  ),
                                ],
                              ),
