...
class AddLaporanPoskoPage extends StatefulWidget {
  static String routeName = '/add-laporan-posko-page';
  const AddLaporanPoskoPage({super.key});

  @override
  State<AddLaporanPoskoPage> createState() => _AddLaporanPoskoPageState();
}

class _AddLaporanPoskoPageState extends State<AddLaporanPoskoPage> {
  ...
  Widget build(BuildContext context) {
    AddLaporanController controller = Get.put(AddLaporanController(
                ...
                children: [
                  Expanded(
                    child: CustomTextField(
                      ...
                      label: 'Cuaca',
                      enable: false, // Changed from readOnly: true
                    ),
                  ),
        ...
        child: Column(
          children: _weatherOptions
              .map((option) => ListTile(
                    ...
                    onTap: () {
                      setState(() => _weatherController.text = option);
