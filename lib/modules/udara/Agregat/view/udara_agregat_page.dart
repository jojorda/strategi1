...
class UdaraAgregatPage extends GetView<UdaraController> {
  static const routeName = '/aggregate';
  const UdaraAgregatPage({super.key});
      ...
      children: [
        ...
        Text(
          ...
          style: Get.textTheme.labelMedium!.copyWith(
            color: color,
            fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 11),
          ),
        ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'Penumpang Penerbangan Domestik & International',
          ...
          _buildFlightChart(type: 'passengers'),
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'Penerbangan Domestik & International',
                  style: Get.textTheme.titleSmall!.copyWith(
                    fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : 14),
                  ),
                ),
          ...
          _buildFlightChart(type: 'aircraft'),
          const SizedBox(height: 8),
        ],
      ),
    );
  ...
  Widget _buildFlightChart({required String type}) {
    assert(type == 'passengers' || type == 'aircraft');

    return Obx(() {
      final chartData = type == 'passengers'
          ? controller.currentAggregateData.value?.chartFlight?.passengers
          : controller.currentAggregateData.value?.chartFlight?.aircraft;
      ...
      return SizedBox(
        height: 100,
        child: _buildFlightCartesianChart(chartData, maxValue.toDouble()),
      );
    });
  }

  Widget _buildFlightCartesianChart(
    ...
    return SfCartesianChart(
      ...
      series: <CartesianSeries<MapEntry<String, int>, String>>[
        StackedBarSeries<MapEntry<String, int>, String>(
          dataSource: _mapFlightData(chartData),
          xValueMapper: (data, _) => _mapFlightToLabel(data),
  ...
  String _mapFlightToLabel(MapEntry<String, dynamic> data) {
    switch (data.key) {
      case 'inbound':
  ...
  List<MapEntry<String, int>> _mapFlightData(Map<String, dynamic> chartData) {
