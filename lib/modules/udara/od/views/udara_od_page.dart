...
class UdaraOdPage extends GetView<UdaraController> {
  const UdaraOdPage({super.key});
            ...
            child: value == true
                ? Center(
                    child: Icon(
                      ...
                      size: isUnfolded
                          ? Sizes.s14
                          : (isSmallScreen ? Sizes.s14 : Sizes.s16),
...
class OdChart extends GetView<UdaraController> {
  final List<OdChartData> chartData;
