...
import 'package:strategi_hub_app/modules/udara/operator/controllers/udara_operator_perizinan_controller.dart';
import 'package:strategi_hub_app/modules/udara/operator/views/detail_udara_operator_page.dart';

class UdaraPerizinanPage extends StatefulWidget {
  static String routeName = '/udara-perizinan-page';
  const UdaraPerizinanPage({super.key});

  @override
  State<UdaraPerizinanPage> createState() => _UdaraPerizinanPageState();
}

class _UdaraPerizinanPageState extends State<UdaraPerizinanPage> {
  late UdaraOperatorPerizinanController controller;

  @override
  void initState() {
    controller = Get.put(UdaraOperatorPerizinanController());
    controller.onInit();
    super.initState();
  }
