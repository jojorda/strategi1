...
import 'package:strategi_hub_app/modules/udara/operator/controllers/udara_operator_detail_controller.dart';
...
class DetailUdaraOperatorPage extends StatefulWidget {
  static String routeName = '/detail-udara-operator-page';
  const DetailUdaraOperatorPage({super.key});

  @override
  State<DetailUdaraOperatorPage> createState() =>
      _DetailUdaraOperatorPageState();
}

class _DetailUdaraOperatorPageState extends State<DetailUdaraOperatorPage> {
  late UdaraOperatorDetailController controller;

  @override
  void initState() {
    controller = Get.put(UdaraOperatorDetailController(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            style: Get.textTheme.labelLarge!
                                .copyWith(fontWeight: FontWeight.bold, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s14)),
                            ),
                              ...
                              children: [
                                ...
                                Text(
                                  controller.operatorData.value?.contactPhone ??
                                      "",
                                style: Get.textTheme.titleSmall!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s14)),
                                ),
                              ],
                            ),
                            Row(
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Rata - Rata OTP',
                      style: Get.textTheme.labelLarge!.copyWith(fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s14)),
                      ),
                    ),
                    Container(
                      decoration: BoxDecoration(
                      ...
                      child: Center(
                        ...
                        style: Get.textTheme.titleMedium!
                            .copyWith(color: AppColors.whiteColor, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s14)),
                        ),
                      ),
                    )
                  ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: CustomPrimaryButtons(
                          ...
                          onPress: () {
                            Get.toNamed(
                              UdaraOriginDestinationPage.routeName,
                              arguments:
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        style: Get.textTheme.labelMedium!
                            .copyWith(fontWeight: FontWeight.w400, fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : FontSizes.s14)),
                      ),
                    ),
                    Expanded(
                      child: Text(
