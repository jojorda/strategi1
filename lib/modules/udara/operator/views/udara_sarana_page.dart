...
import 'package:strategi_hub_app/modules/udara/operator/controllers/udara_operator_sarana_controller.dart';
import 'package:strategi_hub_app/modules/udara/operator/views/udara_perizinan_page.dart';

class UdaraSaranaPage extends StatefulWidget {
  static String routeName = '/udara-sarana-page';
  const UdaraSaranaPage({super.key});

  @override
  State<UdaraSaranaPage> createState() => _UdaraSaranaPageState();
}

class _UdaraSaranaPageState extends State<UdaraSaranaPage> {
  late UdaraOperatorSaranaController controller;

  @override
  void initState() {
    controller = Get.put(UdaraOperatorSaranaController(
                ...
                Expanded(
                  child: Stack(
                    children: [
                      ...
                      Visibility(
                        visible: !controller.isLoadingOperatorsData.value &&
                            controller.saranaListData.value.isEmpty,
                        child: Center(
                          child: Text("Tidak ada data sarana",
