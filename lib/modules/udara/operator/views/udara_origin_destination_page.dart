...
import 'package:strategi_hub_app/modules/udara/operator/controllers/udara_operator_od_controller.dart';

class UdaraOriginDestinationPage extends StatefulWidget {
  static String routeName = '/udara-origin-destination-page';
  const UdaraOriginDestinationPage({super.key});

  @override
  State<UdaraOriginDestinationPage> createState() => _UdaraOriginDestinationPageState();
}

class _UdaraOriginDestinationPageState extends State<UdaraOriginDestinationPage> {
  late UdaraOperatorOdController controller;

  @override
  void initState() {
    controller = Get.put(UdaraOperatorOdController(
          ...
          child: Obx(
            () => Column(
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        style: Get.textTheme.labelLarge!.copyWith(
                          fontSize: isUnfolded ? 14 : (isSmallScreen ? 12 : 13),
                        ),
              ...
              style: Get.textTheme.bodyMedium!
                  .copyWith(fontWeight: FontWeight.w500, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : FontSizes.s14)),
                ),
                SizedBox(height: Sizes.s10),
                Expanded(
                  child: Stack(
                    children: [
                      ...
                      Visibility(
                        visible: !controller.isLoadingOperatorsOdData.value &&
                            controller.operatorOdData.value.isEmpty,
                        child: Center(
                          child: Text("Tidak ada data OD",
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              style: Get.textTheme.labelLarge!
                                  .copyWith(fontWeight: FontWeight.w400, fontSize: isUnfolded ? 14 : (isSmallScreen ? 14 : FontSizes.s14)),
                                    ),
                                  ),
                                  Expanded(
                                    child: Column(
