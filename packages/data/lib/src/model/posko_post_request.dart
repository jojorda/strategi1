...
part 'posko_post_request.g.dart';
...
/// * [fokusPantau] 
@BuiltValue()
abstract class PoskoPostRequest implements Built<PoskoPostRequest, PoskoPostRequestBuilder> {
  ...
  factory PoskoPostRequest([void updates(PoskoPostRequestBuilder b)]) = _$PoskoPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PoskoPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PoskoPostRequest> get serializer => _$PoskoPostRequestSerializer();
}

class _$PoskoPostRequestSerializer implements PrimitiveSerializer<PoskoPostRequest> {
  @override
  final Iterable<Type> types = const [PoskoPostRequest, _$PoskoPostRequest];

  @override
  final String wireName = r'PoskoPostRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PoskoPostRequest object, {
  ...
  void _deserializeProperties(
    ...
    required PoskoPostRequestBuilder result,
  ...
  @override
  PoskoPostRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PoskoPostRequestBuilder();
