...
part of 'focus_cctv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const FocusCCTVStatusEnum _$focusCCTVStatusEnum_online =
    const FocusCCTVStatusEnum._('online');
const FocusCCTVStatusEnum _$focusCCTVStatusEnum_offline =
    const FocusCCTVStatusEnum._('offline');

FocusCCTVStatusEnum _$focusCCTVStatusEnumValueOf(String name) {
  switch (name) {
    case 'online':
      return _$focusCCTVStatusEnum_online;
    case 'offline':
      return _$focusCCTVStatusEnum_offline;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<FocusCCTVStatusEnum> _$focusCCTVStatusEnumValues =
    new BuiltSet<FocusCCTVStatusEnum>(const <FocusCCTVStatusEnum>[
  _$focusCCTVStatusEnum_online,
  _$focusCCTVStatusEnum_offline,
]);

Serializer<FocusCCTVStatusEnum> _$focusCCTVStatusEnumSerializer =
    new _$FocusCCTVStatusEnumSerializer();

class _$FocusCCTVStatusEnumSerializer
    implements PrimitiveSerializer<FocusCCTVStatusEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[FocusCCTVStatusEnum];
  @override
  final String wireName = 'FocusCCTVStatusEnum';

  @override
  Object serialize(Serializers serializers, FocusCCTVStatusEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  FocusCCTVStatusEnum deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      FocusCCTVStatusEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$FocusCCTV extends FocusCCTV {
  @override
  final String? id;
  @override
  ...
  @override
  final FocusCCTVStatusEnum? status;
  @override
  ...
  factory _$FocusCCTV([void Function(FocusCCTVBuilder)? updates]) =>
      (new FocusCCTVBuilder()..update(updates))._build();
  ...
  @override
  FocusCCTV rebuild(void Function(FocusCCTVBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FocusCCTVBuilder toBuilder() => new FocusCCTVBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FocusCCTV &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FocusCCTV')
          ..add('id', id)
...
class FocusCCTVBuilder implements Builder<FocusCCTV, FocusCCTVBuilder> {
  _$FocusCCTV? _$v;
  ...
  FocusCCTVStatusEnum? _status;
  FocusCCTVStatusEnum? get status => _$this._status;
  set status(FocusCCTVStatusEnum? status) => _$this._status = status;
  ...
  FocusCCTVBuilder() {
    FocusCCTV._defaults(this);
  }

  FocusCCTVBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(FocusCCTV other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$FocusCCTV;
  }

  @override
  void update(void Function(FocusCCTVBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  FocusCCTV build() => _build();
