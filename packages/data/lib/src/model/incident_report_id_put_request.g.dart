...
part of 'incident_report_id_put_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IncidentReportIdPutRequest extends IncidentReportIdPutRequest {
  @override
  final String nama;
  @override
  final String? email;
  ...
  @override
  final IncidentReportIdPutRequestLaporanKejadianDetail? laporanKejadianDetail;

  factory _$IncidentReportIdPutRequest(
          [void Function(IncidentReportIdPutRequestBuilder)? updates]) =>
      (new IncidentReportIdPutRequestBuilder()..update(updates))._build();

  _$IncidentReportIdPutRequest._(
      {required this.nama,
      this.email,
      this.noHp,
    ...
    BuiltValueNullFieldError.checkNotNull(
        nama, r'IncidentReportIdPutRequest', 'nama');
    BuiltValueNullFieldError.checkNotNull(
        waktuKejadian, r'IncidentReportIdPutRequest', 'waktuKejadian');
    BuiltValueNullFieldError.checkNotNull(
        kronologiKejadian, r'IncidentReportIdPutRequest', 'kronologiKejadian');
    BuiltValueNullFieldError.checkNotNull(
        lokasi, r'IncidentReportIdPutRequest', 'lokasi');
  }

  @override
  IncidentReportIdPutRequest rebuild(
          void Function(IncidentReportIdPutRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IncidentReportIdPutRequestBuilder toBuilder() =>
      new IncidentReportIdPutRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is IncidentReportIdPutRequest &&
        nama == other.nama &&
        email == other.email &&
        noHp == other.noHp &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'IncidentReportIdPutRequest')
          ..add('nama', nama)
          ..add('email', email)
          ..add('noHp', noHp)
...
class IncidentReportIdPutRequestBuilder
    implements
        Builder<IncidentReportIdPutRequest, IncidentReportIdPutRequestBuilder> {
  _$IncidentReportIdPutRequest? _$v;
  ...
  IncidentReportIdPutRequestLaporanKejadianDetailBuilder?
      _laporanKejadianDetail;
  IncidentReportIdPutRequestLaporanKejadianDetailBuilder
      get laporanKejadianDetail => _$this._laporanKejadianDetail ??=
          new IncidentReportIdPutRequestLaporanKejadianDetailBuilder();
  set laporanKejadianDetail(
          IncidentReportIdPutRequestLaporanKejadianDetailBuilder?
              laporanKejadianDetail) =>
      _$this._laporanKejadianDetail = laporanKejadianDetail;

  IncidentReportIdPutRequestBuilder() {
    IncidentReportIdPutRequest._defaults(this);
  }

  IncidentReportIdPutRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _nama = $v.nama;
      _email = $v.email;
  ...
  @override
  void replace(IncidentReportIdPutRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$IncidentReportIdPutRequest;
  }

  @override
  void update(void Function(IncidentReportIdPutRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  IncidentReportIdPutRequest build() => _build();

  _$IncidentReportIdPutRequest _build() {
    _$IncidentReportIdPutRequest _$result;
    try {
      _$result = _$v ??
          new _$IncidentReportIdPutRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'IncidentReportIdPutRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
