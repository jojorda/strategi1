...
import 'package:strategi_mobile_api/src/model/incident_report_id_put_request_laporan_kejadian_detail.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'incident_report_id_put_request.g.dart';

/// IncidentReportIdPutRequest
///
/// Properties:
...
@BuiltValue()
abstract class IncidentReportIdPutRequest implements Built<IncidentReportIdPutRequest, IncidentReportIdPutRequestBuilder> {
  ...
  IncidentReportIdPutRequestLaporanKejadianDetail? get laporanKejadianDetail;

  IncidentReportIdPutRequest._();

  factory IncidentReportIdPutRequest([void updates(IncidentReportIdPutRequestBuilder b)]) = _$IncidentReportIdPutRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IncidentReportIdPutRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IncidentReportIdPutRequest> get serializer => _$IncidentReportIdPutRequestSerializer();
}

class _$IncidentReportIdPutRequestSerializer implements PrimitiveSerializer<IncidentReportIdPutRequest> {
  @override
  final Iterable<Type> types = const [IncidentReportIdPutRequest, _$IncidentReportIdPutRequest];

  @override
  final String wireName = r'IncidentReportIdPutRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IncidentReportIdPutRequest object, {
    ...
    if (object.laporanKejadianDetail != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(IncidentReportIdPutRequestLaporanKejadianDetail),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required IncidentReportIdPutRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'laporanKejadianDetail':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(IncidentReportIdPutRequestLaporanKejadianDetail),
          ) as IncidentReportIdPutRequestLaporanKejadianDetail;
  ...
  @override
  IncidentReportIdPutRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IncidentReportIdPutRequestBuilder();
