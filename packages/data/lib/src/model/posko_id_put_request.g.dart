...
part of 'posko_id_put_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PoskoIdPutRequest extends PoskoIdPutRequest {
  @override
  ...
  factory _$PoskoIdPutRequest(
          [void Function(PoskoIdPutRequestBuilder)? updates]) =>
      (new PoskoIdPutRequestBuilder()..update(updates))._build();

  _$PoskoIdPutRequest._(
      {this.idJenisPosko,
      this.idEvent,
      this.namaPosko,
      this.alamatPosko,
  ...
  @override
  PoskoIdPutRequest rebuild(void Function(PoskoIdPutRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PoskoIdPutRequestBuilder toBuilder() =>
      new PoskoIdPutRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PoskoIdPutRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PoskoIdPutRequest')
...
class PoskoIdPutRequestBuilder
    implements Builder<PoskoIdPutRequest, PoskoIdPutRequestBuilder> {
  _$PoskoIdPutRequest? _$v;
  ...
  String? _koordinatPosko;
  String? get koordinatPosko => _$this._koordinatPosko;
  set koordinatPosko(String? koordinatPosko) =>
  ...
  PoskoIdPutRequestBuilder() {
    PoskoIdPutRequest._defaults(this);
  }

  PoskoIdPutRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      ...
      _koordinatPosko = $v.koordinatPosko;
  ...
  @override
  void replace(PoskoIdPutRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PoskoIdPutRequest;
  }

  @override
  void update(void Function(PoskoIdPutRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PoskoIdPutRequest build() => _build();

  _$PoskoIdPutRequest _build() {
    _$PoskoIdPutRequest _$result;
    try {
      _$result = _$v ??
          new _$PoskoIdPutRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PoskoIdPutRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
